...
useSeoMeta({
  title: "Daftar Akun - Waletify Personal Finance",
  description:
    "Buat akun baru Waletify untuk memantau dan mengelola keuangan pribadi Anda dengan presisi.",
});
...
async function handleRegister() {
  ...
  try {
    // Only send name, email, password to backend as specified in guide
    await register({
      name: form.name.trim(),
          ...
          >
            <div class="mb-6">
              ...
              <p class="text-slate text-sm leading-relaxed">
                Kelola dompet, transaksi, dan sasaran finansial Anda dalam satu
                tempat yang aman.
              </p>
            </div>
            ...
            <form @submit.prevent="handleRegister" class="space-y-4" novalidate>
              ...
              <!-- Term Agreement Note -->
              <div class="text-xs text-slate leading-relaxed pt-1">
                Dengan mendaftar, Anda menyetujui
                <span class="text-ink font-medium">Ketentuan Layanan</span> dan
                <span class="text-ink font-medium">Kebijakan Privasi</span>
                Waletify.
              </div>
              ...
              >
                ...
                <template v-else>
                  <span>Daftar Akun Waletify</span>
                  <svg
          ...
          <div>
            <div class="flex items-center justify-between mb-6">
              <span
                ...
                >Waletify Financial Overview</span
              >
              <span
            ...
            >
              <div class="flex items-center justify-between mb-2">
                <span
                  ...
                  >Total Saldo Terkonsolidasi</span
                >
                <span
              ...
              <div class="pt-4 border-t border-hairline space-y-3">
                ...
                >
                  <div class="flex items-center gap-3">
                    ...
                    <div>
                      <p class="text-sm font-medium text-ink">Gaji Bulanan</p>
                      <p class="text-xs text-slate">Transfer Masuk · 22 Aug</p>
                    </div>
                  </div>
                ...
                <div class="flex items-center justify-between py-2">
                  <div class="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p class="text-xs text-slate">Kartu Debit · 21 Aug</p>
                    </div>
                  </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              >
                ...
                <div>
                  <p class="text-sm font-semibold text-ink">Multi-Dompet</p>
                  <p class="text-xs text-slate mt-0.5">
                    Kelola kas harian, investasi & tabungan terpisah.
                  </p>
                </div>
              </div>
              ...
              >
                ...
                <div>
                  <p class="text-sm font-semibold text-ink">Grafik Presisi</p>
                  <p class="text-xs text-slate mt-0.5">
                    Angka monospaced tabular tanpa distorsi.
                  </p>
                </div>
              </div>
            </div>
